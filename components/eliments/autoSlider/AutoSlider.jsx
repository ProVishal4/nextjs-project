  ...
  return (
    <>
      <Swiper
        ...
        className={`${style.mySwiper}  rounded-2xl h-[40vh] md:h-[50vh] lg:h-[60vh] md:w-[50vw] lg:w-[40vw] w-[100vw] relative top-[10%]`}
      >
        {data.map((text) => (
          <SwiperSlide key={text.id}>
            <img src={text.image} alt="" className="w-full h-full" />
            <div className="text-zinc-700 dark:text-zinc-300 absolute bottom-5 right-[1.5%] w-[97%]  md:h-50 h-30  rounded-2xl backdrop-blur-lg font-bold text-2xl z-10">

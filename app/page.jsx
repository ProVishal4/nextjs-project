...
import {Section1, Section2, Section3} from '@/components/sections/index.js'
...
const page = () => {
  return (
    <>
      <main className="flex flex-col mx-auto  border-amber-500 border md:w-[95vw] relative md:left-0 lg:w-[57vw]  w-[95vw]  items-start">

...
export default function TermsAndConditions() {
  return (
    <main className="bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl bg-white rounded-2xl shadow-md p-6 sm:p-10">
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            <strong>   CG Wild Explore  </strong> shall not be held liable for
            any loss or damage arising from the use of this website, including
            but not limited to indirect or consequential loss.
          </p>
        </section>
        ...
        <section className="hidden">
          ...
          <p className="mt-2 text-gray-800 font-medium hidden">

  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-700">
      <div className="max-w-5xl mx-auto px-4 py-12">
        {/* Heading */}
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-zinc-300 mb-6">
          About CG Wild Explore
        </h1>

        {/* Intro */}
        <p className="text-gray-700 dark:text-zinc-400 text-lg leading-relaxed mb-6">
          <strong>CG Wild Explore</strong> is a tourism-focused blog website
          dedicated to showcasing the rich culture, natural beauty, and hidden
          travel destinations of <strong>Chhattisgarh</strong>. Our mission is
          to help travelers discover the unexplored side of the state through
          detailed, informative, and inspiring travel content.
        </p>

        {/* Section */}
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-zinc-300 mb-3">
          What We Share
        </h2>
        <p className="text-gray-700 dark:text-zinc-400 leading-relaxed mb-6">
        ...
        <ul className="list-disc list-inside text-gray-700 dark:text-zinc-400 space-y-2 mb-6">

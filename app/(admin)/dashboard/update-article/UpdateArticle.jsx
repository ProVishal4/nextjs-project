...
console.log("client single obj is - ", article)
...
getCagetory()
  ...
  useEffect(() => {
    ...
    //   editor.commands.setContent(oneArticle.description);
    //   console.log(oneArticle);
    // }, [oneArticle, editor]);
    //   keywords: oneArticle.keywords || "",
    //   popular: Boolean(oneArticle.popular),
    // });
...
console.log("_id is :- ", _id)
 ...
 // console.log("running code every render!", oneArticle);
  ...
  // if (loading) {
  // // editor initialized above near form state
  //   onUpdate: ({ editor }) => {
  //     setForm((prev) => ({
  //       ...prev,
  //       description: editor.getHTML(),

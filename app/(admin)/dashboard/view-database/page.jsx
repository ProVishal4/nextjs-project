    ...
    <div className={dark ? "dark" : ""}>
        <div className="min-h-screen p-16 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors duration-200 ">
            <header className="max-w-6xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                <div>
                    <h1 className="text-2xl sm:text-3xl font-semibold">Dashboard — Articles</h1>
            ...
            <main className="max-w-6xl mx-auto grid gap-4">
                {loadingFetch ? (
                    <div className="py-10 text-center text-emerald-500">Loading articles...</div>
                ) : articles.length === 0 ? (
                    <div className="py-10 text-center text-zinc-500">No articles found.</div>
                ) : (
                                ...
                                <div className="flex-1 flex flex-col justify-between">
                                    ...
                                    <div className="mt-3 flex items-center justify-between gap-3">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <Link href={`/api/blog/${item._id}`} className="no-underline">
